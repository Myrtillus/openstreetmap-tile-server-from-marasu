...
build_new:
	...
	docker tag registry.finomena.fi/c/openstreetmap-tile-server-new:latest registry.finomena.fi/c/openstreetmap-tile-server:0.8.1
...
build_new_h:
	...
	docker tag registry-hetzner.finomena.fi/openstreetmap-tile-server-new:latest registry-hetzner.finomena.fi/openstreetmap-tile-server:0.8.1
